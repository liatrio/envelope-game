...
class Timer {
  ...
  async tick(team1Id) {
    ...
    db.promise().query(envCompleted).then(([rows, fields]) => {
      ...
      let updateScore = `UPDATE GAME SET score_1 = score_1 + ${team1Completed}, score_2 = score_2 + ${team2Completed}, game_tick = game_tick + 1, team_1_completed = ${team1Completed}, team_2_completed = ${team2Completed} WHERE game_id = '${this.gameId}'`;
